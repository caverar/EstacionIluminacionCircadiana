...
class UIWrapper(QtWidgets.QMainWindow):
    ...
    def serial_connected_status_receiver(self, val):
        ...
        if(val):
            self.ui.connection_status. setText("Conexión Exitosa")
        else:
            self.ui.connection_status.setText("Conexión Fallida")

    @QtCore.pyqtSlot()
    def serial_disconnected_receiver(self):
        self.ui.connection_status. setText("Conexión Detenida")
